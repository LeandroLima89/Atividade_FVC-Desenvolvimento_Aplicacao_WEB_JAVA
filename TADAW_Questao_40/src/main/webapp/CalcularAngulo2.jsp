<%-- 
    Document   : CalcularAngulo2
    Created on : 30 de mar. de 2026, 15:07:11
    Author     : leo
--%>
...
<html>
    <head>
        ...
        <title>Cálculo de Ângulos e Voltas</title>
    </head>
    <body>
        <h1>Informe uma medida de ângulos:</h1>
        <form action="CalcularAngulo2.jsp" method="POST">
        ...
        <c:if test="${not empty param.angulo}">
            ...
            <p>O ângulo de <c:out value="${angulo}"/>º equivale a <c:out value="${voltas}"/> volta(s) completa(s)</p>
